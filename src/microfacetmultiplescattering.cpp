...
Microsurface::Microsurface(const PropertyList &props) {
    bool height_uniform = props.getBoolean("height_uniform");
    bool slope_beckmann = props.getBoolean("slope_beckmann");
    float alpha_x = props.getFloat("alpha_x");
    float alpha_y = props.getFloat("alpha_y");
    if (height_uniform) {
